    ...
    <Card className="w-full max-w-[95%] sm:max-w-md shadow-none bg-card/0 border-border/0">
      <CardHeader className="space-y-4 pb-2 sm:pb-4">
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">{dict.auth.logInTo} {dict.metadata.title}</h1>
        </div>
      </CardHeader>
      ...
      {/*       <p> */}
      {/*         {dict.auth.byContinuingYouAgreeTo}{" "} */}
      {/*         <Link href="#" className="underline hover:text-foreground"> */}
      {/*           {dict.auth.terms}{" "} */}
      {/*         </Link> */}
      {/*         {dict.auth.and}{" "} */}
      {/*         <Link href="#" className="underline hover:text-foreground"> */}
      {/*           {dict.auth.conditions} */}
      {/*         </Link> */}
      {/*       </p> */}
      {/*     </div> */}
      {/*   </CardFooter> */}
